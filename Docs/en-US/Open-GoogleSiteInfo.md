...
| `-SessionOnly` | SwitchParameter | ☐ | Use session-only mode for browser profile (no<br>persistent data) |
| `-ClearSession` | SwitchParameter | ☐ | Clear browser session/profile data before<br>opening |
| `-SkipSession` | SwitchParameter | ☐ | Skip using a browser session/profile (use<br>default) |
| `-SideBySide` | SwitchParameter | ☐ | Open browser windows side by side |
...
> Use session-only mode for browser profile (no persistent data)
...
> Skip using a browser session/profile (use default)
