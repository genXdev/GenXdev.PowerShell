...
|:---|:---|:---:|:---|
| `-MacAddress` | String[] | ✅ | One or more MAC addresses to send the magic <br>packet to (e.g., 00:11:22:33:44:55) |
| `-BroadcastAddress` | String | ☐ | The broadcast IP address to send the magic <br>packet to (default: 255.255.255.255) |
| `-Port` | Int32 | ☐ | The UDP port to send the magic packet to <br>(default: 4000) |
...
> One or more MAC addresses to send the magic  packet to (e.g., 00:11:22:33:44:55)
...
> The broadcast IP address to send the magic  packet to (default: 255.255.255.255)
...
> The UDP port to send the magic packet to  (default: 4000)
