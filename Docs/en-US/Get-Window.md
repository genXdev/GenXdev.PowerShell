...
|:---|:---|:---:|:---|
| `-ProcessName` | String | ☐ | Name of the process to get window information<br>for 🌐 wildcards |
| `-ProcessId` | Int32 | ☐ | ID of the process to get window information<br>for |
| `-WindowHandle` | Int64 | ☐ | Window handle to get information for |
