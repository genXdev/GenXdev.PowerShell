...
> **SubModule:** GenXdev.Windows | **Type:** Function | **Aliases:** `wp`
...
|:---|:---|:---:|:---|
| `-ProcessName` | String | ☐ | The process name of the window to position 🌐<br>wildcards |
| `-Process` | Diagnostics.Process | ☐ | The process of the window to position |
| `-WindowHelper` | GenXdev.Helpers.WindowObj[] | ☐ | Get-Window helper object for direct window<br>manipulation |
| `-Monitor` | Int32 | ☐ | Monitor selection: 0=primary, 1+=specific<br>monitor, -1=current, -2=secondary |
...
| `-X` | Int32 | ☐ | Window horizontal position in pixels |
| `-Y` | Int32 | ☐ | Window vertical position in pixels |
