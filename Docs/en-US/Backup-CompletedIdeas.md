# Backup-CompletedIdeas

> **SubModule:** GenXdev.Coding | **Type:** Function | **Aliases:** `archive-ideas`
...
|:---|:---|:---:|:---|
| `-Path` | String | ✅ | The file path where completed idea items will<br>be archived to |
