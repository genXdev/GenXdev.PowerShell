...
> **SubModule:** GenXdev.Queries.Webbrowser | **Type:** Function | **Aliases:** `wikipedia`
...
|:---|:---|:---:|:---|
| `-Queries` | String[] | ✅ | The Wikipedia search query to execute |
| `-Language` | String | ☐ | The language of the Wikipedia search results |
...
| `-Monitor` | Int32 | ☐ | The monitor to use, 0 = default, -1 is<br>discard,  -2 = Configured secondary monitor |
...
| `-PassThru` | SwitchParameter | ☐ | Returns a PowerShell process object<br>representing  the browser process |
...
> The Wikipedia search query to execute
...
> The language of the Wikipedia search results
