...
> **SubModule:** GenXdev.Queries.AI | **Type:** Function | **Aliases:** `ask`
...
| `-EndPoint` | String | ☐ | The enpoint to invoke the query on |
...
| `-Minimize` | SwitchParameter | ☐ | Minimize the window after positioning |
