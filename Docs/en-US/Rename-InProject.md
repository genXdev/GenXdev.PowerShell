...
> **SubModule:** GenXdev.FileSystem | **Type:** Function | **Aliases:** `rip`
...
| `-FindText` | String | ✅ | The text to find (case sensitivity controlled<br>by CaseInsensitive parameter) |
| `-ReplacementText` | String | ✅ | The text to replace matches with |
| `-CaseInsensitive` | SwitchParameter | ☐ | Perform case-insensitive text replacement |
