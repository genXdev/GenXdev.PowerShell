...
> **SubModule:** GenXdev.Webbrowser | **Type:** Function | **Aliases:** `wb`
...
|:---|:---|:---:|:---|
| `-Url` | String[] | ☐ | The URLs to open in the browser |
| `-Input` | String | ☐ | The URLs to open in the browser |
...
| `-Force` | SwitchParameter | ☐ | Force close existing browser instances before<br>opening a new one |
...
| `-PreferPlaywrightBrowser` | SwitchParameter | ☐ | Use the bundled Playwright browser binary <br>instead of the OS-installed browser via<br>channel. Only  affects Chrome, Edge, and<br>Chromium modes. Implies  -PlayWright |
...
> Force close existing browser instances before  opening a new one
...
> Use the bundled Playwright browser binary  instead of the OS-installed browser via channel. Only  affects Chrome, Edge, and Chromium modes. Implies  -PlayWright
