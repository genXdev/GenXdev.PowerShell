...
> **SubModule:** GenXdev.Windows | **Type:** Function | **Aliases:** `gwp`
...
|:---|:---|:---:|:---|
| `-ProcessName` | String | ☐ | The process name of the window to get<br>position for 🌐 wildcards |
| `-Process` | Diagnostics.Process | ☐ | The process of the window to get position for |
