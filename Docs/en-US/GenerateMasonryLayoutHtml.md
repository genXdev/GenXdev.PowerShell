...
| `-CanEdit` | SwitchParameter | ☐ | Whether editing is enabled |
| `-CanDelete` | SwitchParameter | ☐ | Whether deletion is enabled |
...
| `-PageSize` | Int32 | ☐ | Number of images to load per page (for<br>dynamic loading) |
| `-MaxPrintImages` | Int32 | ☐ | Maximum number of images to load for print<br>mode |
| `-RootMargin` | String | ☐ | IntersectionObserver rootMargin for infinite<br>scroll trigger (e.g. "1200px |
| `-Threshold` | Double | ☐ | IntersectionObserver threshold for infinite<br>scroll trigger |
