...
> **SubModule:** GenXdev.AI.Queries | **Type:** Function | **Aliases:** `imagepeopledetection`
...
| `-TimeoutSecond` | Int32 | ☐ | Timeout in seconds for the request, defaults<br>to  24 hours |
...
| `-ShowWindow` | SwitchParameter | ☐ | Show Docker window during  initialization |
