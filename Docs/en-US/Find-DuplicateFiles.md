...
> **SubModule:** GenXdev.FileSystem | **Type:** Function | **Aliases:** `fdf`
...
| `-ComparePartial` | SwitchParameter | ☐ | Will return of files with different sizes as<br>long as they start with the same filename and<br>content, this detect broken downloads/copy<br>operations |
| `-CompareByteLength` | Int32 | ☐ | Quick compare byte length of files, used for<br>fast indexing and searching of duplicates,<br>this will not compare content of files |
