# Backup-CompletedReleaseNotes

> **SubModule:** GenXdev.Coding | **Type:** Function | **Aliases:** `archive-releasenotes`

## Synopsis

> Archives completed release note items from the README to an external file.

## Description

Moves all completed (☒) release note items from the "## Release notes"
section of the README.md file to an external archive file. This keeps the
README clean while preserving a history of past releases.
...
|:---|:---|:---:|:---|
| `-Path` | String | ✅ | The file path where completed release note<br>items will be archived to |
...
> The file path where completed release note items will be archived to
