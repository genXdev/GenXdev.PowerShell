...
|:---|:---|:---:|:---|
| `-IncidentAngleInDegrees` | Double | ✅ | Incident angle in degrees |
| `-IndexOfRefraction1` | Double | ✅ | Refractive index of first medium |
| `-IndexOfRefraction2` | Double | ✅ | Refractive index of second medium |
| `-As` | String | ☐ | Output unit for angle |
