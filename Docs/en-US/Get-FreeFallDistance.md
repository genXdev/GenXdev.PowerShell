...
|:---|:---|:---:|:---|
| `-DurationInSeconds` | Double | ✅ | The time duration of the fall in seconds |
| `-TerminalVelocityInMetersPerSecond` | Double | ☐ | The terminal velocity in meters per second<br>(default: 53) |
| `-GravityInMetersPerSecondSquared` | Double | ☐ | The acceleration due to gravity in m/s²<br>(default: 9.81) |
| `-As` | String | ☐ | The unit for the output distance |
