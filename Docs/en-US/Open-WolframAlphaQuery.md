...
> **SubModule:** GenXdev.Queries.Webbrowser | **Type:** Function | **Aliases:** `qalpha`
...
| `-SendKeyUseShiftEnter` | SwitchParameter | ☐ | Send Shift+Enter instead of regular Enter for<br>line breaks when sending keys. |
