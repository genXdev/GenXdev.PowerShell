...
> **SubModule:** GenXdev.Queries.Webbrowser | **Type:** Function | **Aliases:** `whois`
...
| `-SkipSession` | SwitchParameter | ☐ | Store settings only in persistent preferences<br>without  affecting session for AI preferences<br>like Language, Image  collections, etc. |
