...
> **SubModule:** GenXdev.FileSystem | **Type:** Function | **Aliases:** `sdel`
...
|:---|:---|:---:|:---|
| `-Path` | String | ✅ | The directory path to clear |
| `-DeleteFolder` | SwitchParameter | ☐ | Also delete the root folder supplied with the<br>Path parameter |
