...
> **SubModule:** GenXdev.Webbrowser | **Type:** Function | **Aliases:** `sites`
...
|:---|:---|:---:|:---|
| `-Queries` | String[] | ☐ | Search terms to filter bookmarks |
| `-Count` | Int32 | ☐ | Maximum number of urls to open |
| `-Edge` | SwitchParameter | ☐ | Select in Microsoft Edge |
| `-Chrome` | SwitchParameter | ☐ | Select in Google Chrome |
| `-Firefox` | SwitchParameter | ☐ | Select in Firefox |
...
| `-ShowWindow` | SwitchParameter | ☐ | Show the browser window (not 1d or hidden) |
