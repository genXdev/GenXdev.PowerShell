...
> **SubModule:** GenXdev.Queries.Websites | **Type:** Function | **Aliases:** `yabbattle`
...
| `-SendKeyDelayMilliSeconds` | Int32 | ☐ | Delay in milliseconds between sending each<br>key. |
...
| `-RestoreFocus` | SwitchParameter | ☐ | Restore focus to the previous window after<br>opening the browser. |
