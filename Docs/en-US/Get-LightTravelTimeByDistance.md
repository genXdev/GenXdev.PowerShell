...
|:---|:---|:---:|:---|
| `-DistanceInMeters` | Double | ✅ | Distance in meters |
| `-SpeedOfLightInMetersPerSecond` | Double | ☐ | Speed of light in m/s (default: 299792458) |
| `-Medium` | String | ✅ | The medium through which light travels |
| `-As` | String | ☐ | Output unit for time |
