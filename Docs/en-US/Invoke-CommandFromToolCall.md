...
|:---|:---|:---:|:---|
| `-ToolCall` | Collections.Hashtable | ✅ | Tool call object containing function details<br>and args |
...
| `-ForceAsText` | SwitchParameter | ☐ | Force output as text |
...
> Tool call object containing function details and args
