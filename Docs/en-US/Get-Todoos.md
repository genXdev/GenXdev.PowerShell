...
> **SubModule:** GenXdev.Coding | **Type:** Function | **Aliases:** `todoos`
...
| `-First` | Int32 | ☐ | Limit output to the first N lines |
| `-OnlyCompleted` | SwitchParameter | ☐ | Show only completed (☒) items |
| `-ExcludeCompleted` | SwitchParameter | ☐ | Exclude completed (☒) items, showing only<br>incomplete |
...
> Exclude completed (☒) items, showing only incomplete
