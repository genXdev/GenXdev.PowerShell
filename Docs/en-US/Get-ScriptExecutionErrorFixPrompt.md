...
> **SubModule:** GenXdev.AI.Queries | **Type:** Function | **Aliases:** `getfixprompt`
...
|:---|:---|:---:|:---|
| `-Script` | ScriptBlock | ✅ | The script to execute and analyze for errors |
...
| `-Attachments` | Object | ☐ | Attachments to include in the LLM query. |
| `-ImageDetail` | Object | ☐ | Level of image detail for LLM query. |
| `-TTLSeconds` | Object | ☐ | Time-to-live in seconds for the LLM query. |
| `-IncludeThoughts` | Object | ☐ | Include model thoughts in the LLM response. |
| `-OutputMarkdownBlocksOnly` | Object | ☐ | Output only markup blocks from the LLM<br>response. |
| `-MarkupBlocksTypeFilter` | Object | ☐ | Filter for markup block types in the LLM<br>response. |
| `-ChatOnce` | Object | ☐ | Run chat only once for the LLM query. |
| `-MaxToolcallBackLength` | Object | ☐ | Maximum tool call back length for LLM query. |
| `-AudioTemperature` | Object | ☐ | Temperature for audio generation. |
| `-TemperatureResponse` | Object | ☐ | Temperature for response generation. |
| `-Language` | Object | ☐ | Language for LLM query. |
| `-CpuThreads` | Object | ☐ | Number of CPU threads to use. |
| `-SuppressRegex` | Object | ☐ | Regular expression to suppress output. |
| `-AudioContextSize` | Object | ☐ | Audio context size for LLM query. |
| `-SilenceThreshold` | Object | ☐ | Silence threshold for audio processing. |
| `-LengthPenalty` | Object | ☐ | Length penalty for LLM output. |
| `-EntropyThreshold` | Object | ☐ | Entropy threshold for LLM output. |
| `-LogProbThreshold` | Object | ☐ | Log probability threshold for LLM output. |
| `-NoSpeechThreshold` | Object | ☐ | No speech threshold for audio processing. |
| `-DontSpeak` | Object | ☐ | Do not speak audio output. |
| `-DontSpeakThoughts` | Object | ☐ | Do not speak model thoughts. |
| `-NoVOX` | Object | ☐ | Disable VOX for audio output. |
| `-UseDesktopAudioCapture` | Object | ☐ | Use desktop audio capture. |
| `-NoContext` | Object | ☐ | Do not use context for LLM query. |
| `-WithBeamSearchSamplingStrategy` | Object | ☐ | Use beam search sampling strategy. |
| `-OnlyResponses` | Object | ☐ | Return only responses from LLM. |
