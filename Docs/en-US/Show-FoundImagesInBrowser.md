...
> **SubModule:** GenXdev.AI.Queries | **Type:** Function | **Aliases:** `showfoundimages`
...
|:---|:---|:---:|:---|
| `-InputObject` | Object[] | ☐ | Image data objects to display in the gallery. |
| `-Interactive` | SwitchParameter | ☐ | Will connect to browser and adds additional<br>buttons  like Edit and Delete |
| `-Title` | String | ☐ | Title for the gallery |
| `-Description` | String | ☐ | Hover over images to see face recognition and<br>object detection data |
...
| `-NewWindow` | SwitchParameter | ☐ | Create a new browser window instead of<br>reusing  existing one |
| `-OnlyReturnHtml` | SwitchParameter | ☐ | Only return the generated HTML instead of <br>displaying it in a browser. |
| `-EmbedImages` | SwitchParameter | ☐ | Embed images as base64 data URLs instead of <br>file:// URLs for better portability. |
...
| `-PassThru` | SwitchParameter | ☐ | Return the browser window helper object for<br>further manipulation |
