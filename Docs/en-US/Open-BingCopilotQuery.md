...
> **SubModule:** GenXdev.Queries.AI | **Type:** Function | **Aliases:** `aibc`
...
| `-ClearSession` | SwitchParameter | ☐ | Clear browser session/profile before opening. |
| `-SkipSession` | SwitchParameter | ☐ | Skip browser session/profile loading. |
...
> Clear browser session/profile before opening.
...
> Skip browser session/profile loading.
...
- [Open-ChatGPTQuery](https://github.com/genXdev/GenXdev.PowerShell/blob/main/Docs/en-US/Open-ChatGPTQuery.md)
