...
> **SubModule:** GenXdev.Queries.Websites | **Type:** Function | **Aliases:** `viral`
...
|:---|:---|:---:|:---|
| `-Language` | String | ☐ | The language for the web content display and<br>browser language settings |
