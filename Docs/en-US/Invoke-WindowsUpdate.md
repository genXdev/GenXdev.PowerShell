...
> **SubModule:** GenXdev.Windows | **Type:** Function | **Aliases:** `updatewindows`
...
|:---|:---|:---:|:---|
| `-Install` | SwitchParameter | ☐ | Automatically install available Windows<br>updates |
| `-AutoReboot` | SwitchParameter | ☐ | Automatically reboot if updates require a<br>restart |
| `-Criteria` | String | ☐ | Custom Windows Update search criteria |
| `-IncludeDrivers` | SwitchParameter | ☐ | Include drivers in update search |
| `-ProcessOptionalUpdates` | SwitchParameter | ☐ | Include optional updates and prompt to<br>install each one |
| `-GroupByCategory` | SwitchParameter | ☐ | Group and color output by update category |
| `-NoBanner` | SwitchParameter | ☐ | Disable banner/status output |
| `-NoRebootCheck` | SwitchParameter | ☐ | Skip reboot requirement check/reporting |
