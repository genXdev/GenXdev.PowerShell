...
|:---|:---|:---:|:---|
| `-RefactorDefinition` | GenXdev.Helpers.RefactorDefinition | ✅ | The refactor definition containing LLM<br>settings |
| `-Path` | String | ✅ | The path to the source file to evaluate |
