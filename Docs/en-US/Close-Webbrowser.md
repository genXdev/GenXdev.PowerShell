...
> **SubModule:** GenXdev.Webbrowser | **Type:** Function | **Aliases:** `wbc`
...
|:---|:---|:---:|:---|
| `-Edge` | SwitchParameter | ☐ | Closes Microsoft Edge browser instances |
| `-Chrome` | SwitchParameter | ☐ | Closes Google Chrome browser instances |
| `-Chromium` | SwitchParameter | ☐ | Closes default chromium-based browser |
| `-Firefox` | SwitchParameter | ☐ | Closes Firefox browser instances |
...
| `-IncludeBackgroundProcesses` | SwitchParameter | ☐ | Closes all instances including background<br>tasks |
