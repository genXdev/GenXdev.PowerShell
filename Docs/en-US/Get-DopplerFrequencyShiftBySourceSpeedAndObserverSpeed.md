...
|:---|:---|:---:|:---|
| `-OriginalFrequencyInHertz` | Double | ✅ | Original frequency in Hz |
| `-SourceSpeedInMetersPerSecond` | Double | ✅ | Source speed in m/s (positive towards<br>observer) |
| `-ObserverSpeedInMetersPerSecond` | Double | ✅ | Observer speed in m/s (positive towards<br>source) |
| `-SpeedOfSoundInMetersPerSecond` | Double | ☐ | Speed of sound in m/s (default: 343) |
| `-Medium` | String | ✅ | The medium |
| `-As` | String | ☐ | Output unit for frequency |
...
- [Get-PotentialEnergyByMassHeightAndGravity](https://github.com/genXdev/GenXdev.PowerShell/blob/main/Docs/en-US/Get-PotentialEnergyByMassHeightAndGravity.md)
