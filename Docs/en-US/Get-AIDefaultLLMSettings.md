...
| `-Model` | String | ☐ | Filter configurations by model identifier or<br>pattern |
| `-ApiEndpoint` | String | ☐ | Filter configurations by API endpoint URL |
| `-ApiKey` | String | ☐ | Filter configurations by API key |
