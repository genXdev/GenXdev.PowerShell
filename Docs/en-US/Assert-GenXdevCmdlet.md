...
> **SubModule:** GenXdev.Coding.PowerShell.Modules | **Type:** Function | **Aliases:** `improvecmdlet`
...
| `-NoLocal` | SwitchParameter | ☐ | Skip local module versions |
| `-OnlyPublished` | SwitchParameter | ☐ | Only include published versions |
| `-FromScripts` | SwitchParameter | ☐ | Search in script files |
| `-Code` | SwitchParameter | ☐ | Open in Visual Studio Code |
| `-VisualStudio` | SwitchParameter | ☐ | Open in Visual Studio |
| `-EditPrompt` | SwitchParameter | ☐ | Only edit the AI prompt |
| `-Integrate` | SwitchParameter | ☐ | Integrate cmdlet into module |
