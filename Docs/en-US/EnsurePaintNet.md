...
|:---|:---|:---:|:---|
| `-AutoConsent` | SwitchParameter | ☐ | Automatically consent to Paint.NET and WinGet<br>module installation and set persistent flag. |
...
> Automatically consent to Paint.NET and WinGet  module installation and set persistent flag.
