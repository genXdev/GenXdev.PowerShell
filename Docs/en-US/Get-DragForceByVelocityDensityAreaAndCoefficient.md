...
|:---|:---|:---:|:---|
| `-VelocityInMetersPerSecond` | Double | ✅ | Velocity in m/s |
| `-DensityInKilogramsPerCubicMeter` | Double | ✅ | Fluid density in kg/m³ |
| `-AreaInSquareMeters` | Double | ✅ | Cross-sectional area in m² |
| `-Coefficient` | Double | ✅ | Drag coefficient |
| `-As` | String | ☐ | Output unit for force |
