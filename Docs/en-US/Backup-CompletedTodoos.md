# Backup-CompletedTodoos

> **SubModule:** GenXdev.Coding | **Type:** Function | **Aliases:** `archive-todoos`
...
|:---|:---|:---:|:---|
| `-Path` | String | ✅ | The file path where completed todo items will<br>be archived to |
