...
.DESCRIPTION
* Moves up four directory levels from the current location in the
  filesystem.
* After navigation, displays the contents of the resulting directory.
...
Uses the alias to navigate up four directory levels.
")]
    [Cmdlet(VerbsCommon.Set, "LocationParent4", SupportsShouldProcess = true)]
    [Alias(".....")]
    [OutputType(typeof(PSObject))]
    public class SetLocationParent4Command : PSGenXdevCmdlet
    {
        /// <summary>
        ...
        protected override void BeginProcessing()
        {
            ...
            WriteVerbose("Starting navigation up four directory levels from " +
        ...
        {
            // Loop through four levels of navigation
            for (int i = 1; i <= 4; i++)
            {
