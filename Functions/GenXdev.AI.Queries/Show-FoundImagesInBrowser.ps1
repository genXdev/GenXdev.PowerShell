...
function Show-FoundImagesInBrowser {
    ...
    process {
        ...
        if ($Interactive) {
            ...
            # try {
            #     $paramsST = GenXdev\Copy-IdenticalParamValues `
            #         -BoundParameters $PSBoundParameters `
            #         -FunctionName 'GenXdev\Select-WebbrowserTab'
            #     $null = GenXdev\Select-WebbrowserTab @paramsST
            ...
            #     $paramsWBT = GenXdev\Copy-IdenticalParamValues `
            #         -BoundParameters $PSBoundParameters `
            #         -FunctionName 'GenXdev\Select-WebbrowserTab'
            #     $null = GenXdev\Close-Webbrowser `
            #         @paramsWBT -Force -PlayWright
            # }
            ...
            $reference = GenXdev\Open-PlaywrightBrowser `
                @params

            $paramsSTL = GenXdev\Copy-IdenticalParamValues `
                -BoundParameters $PSBoundParameters `
                -FunctionName 'GenXdev\Set-WebbrowserTabLocation'
            GenXdev\Set-WebbrowserTabLocation @paramsSTL $filePathUrl -ByReference $reference
