Pester\Describe 'Rename-InProject' {
    ...
    Pester\AfterAll {
        ...
        # cleanup test folder
        GenXdev\Remove-AllItems -Confirm:$False  $Script:testRoot -DeleteFolder
    }
    ...
    Pester\It 'Replaces text content in files' {
        GenXdev\Rename-InProject -Source .\ -FindText 'oldtext' -ReplacementText 'newtext'
    ...
    Pester\It 'Renames files containing search text' {
        GenXdev\Rename-InProject -Source .\ -FindText 'old' -ReplacementText 'new'
    ...
    Pester\It 'Renames directories containing search text' {
        GenXdev\Rename-InProject -Source . -FindText 'OldName' -ReplacementText 'NewName'
    ...
    Pester\It 'Performs no changes in WhatIf mode' {
        $null = GenXdev\Rename-InProject -Source . -FindText 'oldtext' -ReplacementText 'newtext' -WhatIf
